...
<script>
    ...
    xmlhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            ...
            if (response == '100') {
                ...
                progressTxt.innerHTML = 'Instalação em andamento (' + response + '% concluído)';
            }
    ...
    progressCheck = setInterval(function() {
        xmlhttp.open("GET", "/saas/check/{{ $object['Env'][0]['value'] }}", true);
        xmlhttp.send();
    }, 3000)
</script>
@endsection
